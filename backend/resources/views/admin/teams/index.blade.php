            ...
            <tr class="border-t">
                ...
                <td class="p-2">
                    <div class="flex justify-center gap-2">
                        <a href="{{ route('teams.edit', $team) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Editar</a>

                        <form method="POST" action="{{ route('teams.destroy', $team) }}">
                            @csrf
                            @method('DELETE')
                            <button class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700" onclick="return confirm('¿Seguro que quieres eliminar este equipo?')">Eliminar</button>
                        </form>
                    </div>
                </td>
            </tr>
